...
namespace A4.Tests
{
    ...
    public class ProgramTests
    {
        ...
        {
            TestTools.RunLocalTest("A4",
                Program.ProcessMaximizingOnlineAdRevenue3, "TD3");
        }
        ...
        {
            TestTools.RunLocalTest("A4",
                Program.ProcessCollectingSignatures4, "TD4");
        }
        ...
        {
            TestTools.RunLocalTest("A4",
                Program.ProcessMaximizeNumberOfPrizePlaces5, "TD5");
        }
        ...
        {
            TestTools.RunLocalTest("A4",
                Program.ProcessMaximizeSalary6, "TD6");
        }
    }
}